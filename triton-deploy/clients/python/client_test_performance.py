...
#        print(f"Run inference thread {self.thread_num}")
        ...
        # print(results)
        # print("inference done ",self.thread_num)
...
if __name__ == '__main__':
    ...
    if FLAGS.mode == 'image':
        ...
        # httpclient
        #grpcclient
        inputs.append(httpclient.InferInput('data', [1, 3, FLAGS.width, FLAGS.height], "FP32"))
...
#         os.makedirs('output/')
        ...
        try:
            ...
            for thread_num in range(NUM_THREADS):
                ...
                triton_client_element = httpclient.InferenceServerClient(
                url="localhost:8220",
                verbose=FLAGS.verbose,
                concurrency = 1
                )
            ...
            print("FPS: ",NUM_THREADS*many_time/(time.time()-start_time),(time.time()-start_time))
        except:
